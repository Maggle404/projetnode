...
exports.create = async(req, res)=>{
    ...
    const result = await conn.query('SELECT * from client where email = ?', [email])
    console.log(result);
    ...
    await conn.query('insert into client (nom, prenom, email, password) values (?,?,?,?)', [nom, prenom, email, hashPassword])
    conn.release()
